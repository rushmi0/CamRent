        ...
        try {
            ...
            val dataInfoList = products.mapIndexed { index, product ->
                ...
                ProductsField(
                    ...
                    image1 = if (img1 != "N/A") "${BASE_URL}product/id/${product.productID}/idx/img1/${img1.buildUrl()}" else "N/A",
                    image2 = if (img2 != "N/A") "${BASE_URL}product/id/${product.productID}/idx/img2/${img2.buildUrl()}" else "N/A",
                    image3 = if (img3 != "N/A") "${BASE_URL}product/id/${product.productID}/idx/img3/${img3.buildUrl()}" else "N/A",
                    image4 = if (img4 != "N/A") "${BASE_URL}product/id/${product.productID}/idx/img4/${img4.buildUrl()}" else "N/A",
                    type = product.type,
                    price = product.price,
